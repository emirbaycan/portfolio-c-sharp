...
// ---- Helper Methods ----
bool IsPostgresAvailable(string connectionString)
{
    try
    {
...
if (Environment.GetEnvironmentVariable("ASPNETCORE_ENVIRONMENT") == "Development")
{
    ...
    string connectionString = "Host=localhost;Port=15432;Database=mydb;Username=myuser;Password=mypass";

    if (IsPostgresAvailable(connectionString))
    {
